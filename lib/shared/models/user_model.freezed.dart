...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,email,name,avatarUrl,roleModelImageUrl,dailyCalorieGoal,dailyProteinGoal,dailyCarbsGoal,dailyFatGoal,currentWeight,goalWeight,heightFeet,heightInches,heightCm,birthDate,gender,dailyStepGoal,onboardingCompleted,createdAt]);
...
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.email,_that.name,_that.avatarUrl,_that.roleModelImageUrl,_that.dailyCalorieGoal,_that.dailyProteinGoal,_that.dailyCarbsGoal,_that.dailyFatGoal,_that.currentWeight,_that.goalWeight,_that.heightFeet,_that.heightInches,_that.heightCm,_that.birthDate,_that.gender,_that.dailyStepGoal,_that.onboardingCompleted,_that.createdAt);case _:
  return orElse();
